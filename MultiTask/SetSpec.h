...
//		{ 2.0,	-2.0,	2.0,	-2.0 },					//	m/s2	hoist_acc[ACCELERATION_MAX];
	...
	{0.1,0.1,0.1},	// bh time delay of spdref & fb Level1,2,3
	{0.3,0.1,0.1},	// slew time delay of spdref & fb Level1,2,3
	{0.1,0.1,0.1}	// mh time delay of spdref & fb Level1,2,3
